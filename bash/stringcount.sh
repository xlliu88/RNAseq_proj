...
merged_gtf_EWR="../output/hisat2_ss/transAssembly/stringtie_merged_EWR.gtf"
merged_gtf_LCM="../output/hisat2_ss/transAssembly/stringtie_merged_LCM.gtf"
bfile_path="../output/hisat2_ss/bams/"
out_path="../output/hisat2_ss/ballgown/"
...
count=0
for bam in ${bfile_path}*sorted.bam;
do 
   ...
   if [[ $1 == wet ]];
   then
     stringtie $bam -e -B -G $gtf -A $gene_adb -o $out_gtf -p 4
   fi
